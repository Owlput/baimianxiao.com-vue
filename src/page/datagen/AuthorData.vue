    ...
    <div class="m-[10%] bg-slate-300">
        <form class="h grid grid-cols-1">
            <div class="authorTriGrid">
                <p>Author ID</p>
                <input v-model="authorId" maxlength="8" minlength="8" class="border-2 shadow-md" />
            ...
            <div>
                ...
                <div v-for="(contact, index) in contacts" class="contactGrid">
                    ...
                    <button @click="delContacts(index)" v-show="!(index == 0 && maxContactLength == 1)">
            ...
            <div>
                ...
                <div v-for="(work,index) in recent" class="recentGrid">
                    ...
                    <button @click="delRecent(index)" v-show="!(index == 0 && maxRecentLength == 1)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" style="display:block;margin:auto"
                            fill="rgb(200,50,50)" viewBox="0 0 16 16">
                            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                            <path
...
.contactGrid{
    display: grid;
    grid-template-columns: minmax(5rem,25%) minmax(10rem,65%) minmax(1.5rem,5%) minmax(1.5rem,5%);
    margin: 0.5rem 15%;
}
.authorTriGrid{
    display: grid;
...
.recentGrid{
    display: grid;
    grid-template-columns: minmax(8rem,12rem) minmax(1.5rem,5%) minmax(1.5rem,5%) auto;
    margin: 0.5rem 15%;
}
</style>
